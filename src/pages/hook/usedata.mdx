...
| onAfterSubmitDataOk                 | Función de callback que se llama después de un envío exitoso de datos.                     |
...
| onAfterSubmitDataMemoOk             | Función de callback que se llama después de un envío exitoso de datos de dataMemo.         |
