...
<Iframe src="https://fenextjs-component-storybook.vercel.app/iframe.html?args=&id=component-back--index&viewMode=story" />
...
| useHistoryMinLenght |                boolean                 |    no     |                  false                   | Si el componente esta en estado useHistoryMinLenght, se verificara el valor de "window.history.length" para que sea mayor al Parámetro "minLenght", si la condicion no se cumple, el componente no se renderisa |
...
| typeOnBack | Redireccion       | Descripción                                                         |
| ---------- | :---------------- | :------------------------------------------------------------------ |
