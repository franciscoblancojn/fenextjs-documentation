...
Define el tipo de tema y una constante que contiene los valores posibles para configurar el tema.

### Importación

Para importar el componente ThemeProps, se puede hacer desde fenextjs
