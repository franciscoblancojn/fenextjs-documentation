...
<Iframe src="https://fenextjs-component-storybook.vercel.app/iframe.html?args=&id=component-steps--index&viewMode=story" />
...
| --------- | ---- | --------- | ------- | ----------- |
| items | \{ label: ReactNode; icon?: ReactNode; content: ReactNode; status?: 'none' \| 'ok' \| 'error'; \}[] | sí | [] | Los elementos que representan cada paso, incluyendo el contenido, etiqueta, ícono y estado del paso. |
...
| useStep | boolean | no | false | Determina si el componente debe controlar internamente el estado del paso actual. |
...
Para ver el storybook del componente lo puede hacer con este [link](https://fenextjs-component-storybook.vercel.app/?path=/story/component-steps--index)
