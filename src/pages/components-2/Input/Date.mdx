...
<Iframe src="https://fenextjs-component-storybook.vercel.app/iframe.html?args=&id=component-input-date--index&viewMode=story" />
...
| --------- | ---- | --------- | ------- | ----------- |
| defaultValue | Date \| undefined | no | undefined | Valor predeterminado del campo de entrada de fecha. |
| value | Date \| undefined | no | undefined | Valor actual del campo de entrada de fecha. Si se proporciona, anula el valor predeterminado. |
| type | TypeDate | no | 'date' | Tipo de campo de entrada. Puede ser 'date', 'month', 'week', o 'time'. |
| min | Date \| undefined | no | undefined | Fecha mínima válida que se puede seleccionar. |
| max | Date \| undefined | no | undefined | Fecha máxima válida que se puede seleccionar. |
...
| validator | Validator | no | undefined | Validador opcional para validar la fecha ingresada. |

### Storybook

Para ver el storybook del componente lo puede hacer con este [link](https://fenextjs-component-storybook.vercel.app/?path=/story/component-input-date--index)
