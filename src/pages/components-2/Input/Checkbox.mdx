...
<Iframe src="https://fenextjs-component-storybook.vercel.app/iframe.html?args=&id=component-input-checkbox--index&viewMode=story" />
...
| --------- | ---- | --------- | ------- | ----------- |
| label | any | no | '' | Etiqueta que se muestra al lado del checkbox. |
...
Para ver el storybook del componente lo puede hacer con este [link](https://fenextjs-component-storybook.vercel.app/?path=/story/component-input-checkbox--index)
