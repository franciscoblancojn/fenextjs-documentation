...
<Iframe src="https://fenextjs-component-storybook.vercel.app/iframe.html?args=&id=component-modal--index&viewMode=story" />
...
| useRender | boolean | no | false | Determina si el modal usa renderizado condicional. |
...
Para ver el storybook del componente lo puede hacer con este [link](https://fenextjs-component-storybook.vercel.app/?path=/story/component-modal--index)
