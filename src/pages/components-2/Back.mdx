...
| onClick | function | no | undefined | Función personalizada que se ejecuta al hacer clic en el botón. |
...
| typeOnBack | 'history' | 'router' | 'link' | 'none' | no | 'history' | Tipo de acción a ejecutar al hacer clic en el botón. |
...
| Tipo de back | Redireccion | Descripcion |
| --- | --- | --- |
