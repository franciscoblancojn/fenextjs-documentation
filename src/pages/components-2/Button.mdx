...
| onClick | function | no |  | Función que se ejecuta cuando se hace clic en el botón (solo si no está deshabilitado o en estado de carga). |
| onClickDisabled | function | no |  | Función que se ejecuta cuando se hace clic en el botón estando deshabilitado. |
