...
<Iframe src="https://fenextjs-component-storybook.vercel.app/iframe.html?args=&id=component-img--index&viewMode=story" />
...
| --------- | ---- | --------- | ------- | ----------- |
| src | string | sí | undefined | La URL de la imagen a mostrar. |
...
| imgIf404 | string | no | '' | URL de la imagen que se mostrará en caso de error de carga. |
...
Para ver el storybook del componente lo puede hacer con este [link](https://fenextjs-component-storybook.vercel.app/?path=/story/component-img--index)
